...
// const currentOpportunityId = localStorage.getItem("currentOpportunityId");
...
const AppProvider = ({ children }) => {
  ...
  const addUserToLocalStorage = ({ user, recruiter, token }) => {
    ...
    // localStorage.setItem("currentOpportunityId", currentOpportunityId);
  };
  ...
  const clearFiltersRecruiter = () => {
    ...
    dispatch({ type: CLEAR_FILTERS_RECRUITER });
  };
