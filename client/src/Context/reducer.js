...
const reducer = (state, action) => {
  ...
  if (action.type === REGISTER_RECRUITER_SUCCESS) {
    return {
      ...
      userLocation: action.payload.location, //Why have we mentioned userLocation and jobLocation in case of recruiter as neither we are passing these values from response nor we have these field in the Recruiter Schema
      jobLocation: action.payload.location,
      showAlert: true,
      alertType: "success",
      alertText: "User Created! Redirecting...",
